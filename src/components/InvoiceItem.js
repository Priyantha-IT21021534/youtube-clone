...
const InvoiceItem = (props) => {
    ...
    <>
        ...
        <td className="left strong"  >
            <input name="description" onInput={e => handleChange({description: e.target.value})} value={description} />
        </td>
        <td className="right">
            <input name="qty" onInput={e => handleChange({qty: e.target.value})}  />
        </td>  
        <td className="center" >
            <input name="unitcost" onInput={e => handleChange({unitcost: e.target.value})} value={unitcost} />
        </td>
        <td className="right"  >${qty * unitcost}</td>
         <button className="right" onClick={() => handleInvoiceDelete(id)}>&times;</button>
    </tr>
